...
RUN curl -O https://www.mirrorservice.org/sites/ftp.alsa-project.org/pub/lib/alsa-lib-1.1.8.tar.bz2 \
    && tar xvjf alsa-lib-1.1.8.tar.bz2 && cd alsa-lib-1.1.8 \
    ...
    && cd .. && rm -rf alsa-lib-1.1.8.tar.bz2 alsa-lib-1.1.8
